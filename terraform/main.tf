...
module "generated-template" {
  ...
  api_product_display_name = length(var.namespace) > 0 ? "generated-template${var.namespace}" : "Generated Template"
  api_product_description  = "This is a generated template API"
}
